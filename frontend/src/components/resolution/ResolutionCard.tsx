    ...
    >
      ...
      <div className="relative flex items-start justify-between mb-6">
        <div className="flex items-center gap-4">
          <div
            className={`w-12 h-12 rounded-xl flex items-center justify-center font-black text-lg transition-transform duration-500 group-hover:scale-110 ${
              isRecommended
      ...
      <div className="relative grid grid-cols-3 gap-2 mb-6">
        ...
        <div className="bg-background/40 border border-border/50 rounded-xl p-3 flex flex-col items-center text-center group-hover:border-primary/20 transition-colors">
          <AlertTriangle
            className={`w-4 h-4 mb-1 ${riskLevel === "low" ? "text-success" : "text-warning"}`}
          />
          <span className="text-[10px] text-muted-foreground uppercase font-bold tracking-tighter">
            Risk
          </span>
          <div
            className={`text-lg font-black capitalize ${riskLevel === "low" ? "text-success" : "text-warning"}`}
          >
            {riskLevel}
          </div>
        </div>
